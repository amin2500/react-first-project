    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div className="flex h-20 items-center justify-between">
        <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
          ...
          <NavLink className="flex flex-shrink-0 items-center mr-4" to="/react-first-projects">
            <img
          ...
          <div className="md:ml-auto">
            <div className="flex space-x-2">
              <NavLink
                to="/react-first-projects"
                className={linkClass}
                >Home</NavLink>
              <NavLink
                to="/react-first-project/jobs"
                className={linkClass}
                >Jobs</NavLink>
              <NavLink
                to="/react-first-project/add-job"
                className={linkClass}
                >Add Job</NavLink>
            </div>
          </div>
